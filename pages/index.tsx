...
const defaultEvent = {
  title: 'Eventos',
  description: 'Encuentra los mejores eventos aquí, sigue nuestra página para que no te los pierdas.',
  image: 'https://res.cloudinary.com/killer-diller/image/upload/v1683597421/killer-diller/loader/cr-image-2.jpg'
}
...
const HomePage: NextPage<Props> = ({ events }: Props) => {
  ...
  return (
    !isApplicationLoaded ? (
      ...
      <AnimatePresence>
        <ShopLayout title='Killer Diller | Inicio' pageDescription='Encuentra los mejores productos aquí.'>
          <motion.video
            initial={{
              opacity: 0,
              y: 50,
...
const WhatsAppFab = () => {
  ...
  const message = 'Hola, quiero conocer más acerca de los productos de Killer Diller.';
